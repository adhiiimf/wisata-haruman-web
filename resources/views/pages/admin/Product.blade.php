...
<body class="bg-purple-200">
    ...
    <div class=" sm:ml-64 p-5">
        ...
        <div class="w-auto flex justify-between items-center">
            ...
            <a class="bg-green-500 py-1 px-2 rounded-2xl flex items-center justify-center text-gray-200 no-underline duration-150 ease-in-out hover:no-underline hover:bg-green-600 hover:scale-105 hover:text-green-100" href="">
        ...
        @endphp
            <div class="flex w-auto items-center">
                ...
                <div class="ml-3">
                    <h3 class="text-2xl">{{$data->productTitle}}</h3>
                    ...
                    <div class="flex items-center my-1">
                        ...
                        @switch($data->stocks)
                            @case(1)
                                <div class="ml-2 py-1 px-2 rounded-lg border-green-600 border-2 ">
                                ...
                                @break
                            @case(2)
                                <div class="ml-2 py-1 px-2 rounded-lg border-blue-600 border-2 ">
                                ...
                                @break
                            @case(3)
                                <div class="ml-2 py-1 px-2 rounded-lg border-red-600 border-2 ">
            ...
            <div>
                <a class="bg-cyan-500 py-1 px-2 rounded-2xl flex items-center justify-center text-gray-200 no-underline duration-150 ease-in-out hover:no-underline hover:bg-cyan-600 hover:scale-105 hover:text-green-100 my-1" href="">
                ...
                <a class="bg-red-500 py-1 px-2 rounded-2xl flex items-center justify-center text-gray-200 no-underline duration-150 ease-in-out hover:no-underline hover:bg-red-600 hover:scale-105 hover:text-green-100 my-1" href="">
