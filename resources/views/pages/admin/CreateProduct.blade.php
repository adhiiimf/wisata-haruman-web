        ...
        <div class="container">
            ...
            <form method="post" action="{{ route('post.product') }}" enctype="multipart/form-data">
                ...
                <div class="form-group pt-3">
                    ...
                    <input type="text" name="productTitle" class="form-control rounded-xl border-purple-500 border-2 placeholder:text-gray-400 focus:border-purple-400" placeholder="ketik judul artikel/blog disini" required/>
                </div>
                <label class="block mb-4">
                    <span class="sr-only">Choose File</span>
                    <label>Thumbnail Produk/Barang</label>
                    <input type="file" name="productImage"
                        class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:text-purple-100 file:bg-purple-700 hover:file:bg-purple-800 hover:file:text-white ease-in-out duration-200" required/>
                    @error('productImage')
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="phoneNumber" class="form-control rounded-xl border-purple-500 border-2 placeholder:text-gray-400 focus:border-purple-400" placeholder="08xxxxxxx" required/>
                </div>
                <div class="form-group">
                    <label>Harga (Rupiah)</label>
                    <input type="number" name="price" class="form-control rounded-xl border-purple-500 border-2 placeholder:text-gray-400 focus:border-purple-400" placeholder="4000" required/>
                </div>
                <div class="form-group">
                    <label>Stok Barang</label>
                    <input type="number" name="stocks" class="form-control rounded-xl border-purple-500 border-2 placeholder:text-gray-400 focus:border-purple-400" placeholder="500" required/>
                </div>
                <div>
                ...
                <div class="form-group flex flex-col">
                    ...
                    <div>
                        <textarea id="description" name="description" class="border-purple-500 border-2 w-full rounded-xl py-4 px-4" rows="20" placeholder="Produk ini merupakan..." required></textarea>
                    </div>
                </div>
