...
<body class="bg-purple-200">
    ...
    <div class=" sm:ml-64 p-5">
        ...
        @endphp
            <div class="flex w-auto items-center">
                ...
                <div class="ml-3">
                    ...
                    <div class="flex items-center my-1">
                        <div>
                            <span>Jadwal Wisata : {{$data->name}}</span>
                        </div>
                    </div>
                    <div class="my-2">
            ...
            <div>
                <a class="bg-cyan-500 py-1 px-2 rounded-2xl flex items-center justify-center text-gray-200 no-underline duration-150 ease-in-out hover:no-underline hover:bg-cyan-600 hover:scale-105 hover:text-green-100 my-1" href="/adminViewTravel/{{$data->id}}">
                    <span class="max-lg:!text-lg !text-xl material-icons mr-1">visibility</span>
                    <span class="font-semibold pr-1">Lihat</span>
                </a>
                <a class="bg-orange-500 py-1 px-2 rounded-2xl flex items-center justify-center text-gray-200 no-underline duration-150 ease-in-out hover:no-underline hover:bg-orange-600 hover:scale-105 hover:text-green-100 my-1" href="/adminEditTravel/{{$data->id}}">
                    <span class="max-lg:!text-lg !text-xl material-icons mr-1">edit</span>
                    <span class="font-semibold pr-1">Edit</span>
                </a>
                <a class="bg-red-500 py-1 px-2 rounded-2xl flex items-center justify-center text-gray-200 no-underline duration-150 ease-in-out hover:no-underline hover:bg-red-600 hover:scale-105 hover:text-green-100 my-1" href="/adminDelTravel/{{$data->id}}">
